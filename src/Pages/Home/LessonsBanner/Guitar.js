        ...
        <Box sx={{ flexGrow: 1, padding: '4%' }}>
            <Grid container spacing={2}>
                ...
                <Grid item style={{ padding: '5%' }} xs={12} md={6} sm={12}>
                    ...
                    <Button className='button' sx={{ m: '3%', px: '25px', py: '8px', borderRadius: 10, backgroundColor: '#2EFE64', color: 'black' }} variant="outlined"><i className="fas fa-phone"></i> 1-805-634-678</Button>
                </Grid>
            </Grid>
        </Box>
    );
